...
1. **选家族**：默认 + 每族一张卡片（整卡可点，卡面是该族浅/深拼色预览），卡片最多两行、超出纵向滚动。同一色板的两种表达相邻摆放、同名加后缀——如「电锯人·氛围」「电锯人·简约」。简约版底层是独立的中性族（青灰 / 赭棕 / 青瓷 / 蜜蜡 / 蓝染，与 IP 族共享色板），设置页不额外展示这个名字
