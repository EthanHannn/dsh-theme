...
> 历史：早期版本里高达 / 电锯人同时提供「简约」与「氛围」两种风格；后来简约版拆分为独立的 slate / umber 家族，芙莉莲进合集时直接照此拆出 celadon（配色单一事实源仍分别在 gundam / chainsaw / frieren 参数里，见 `families/slate.mjs` 等文件的再导出注释）。现在每个族只提供一种风格，设置页不再有风格切换芯片。
...
1. **选家族**：默认 / 高达 / 电锯人 / 蜡笔小新 / 芙莉莲 / 青灰 / 赭棕 / 青瓷（卡片左右两半分别预览该族的浅色与深色）
