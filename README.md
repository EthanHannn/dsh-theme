...
**DeepSeek Harness** 主题合集插件：一个插件装全部主题，设置一级「主题与外观」统一入口，每个家族支持浅色 / 深色 / 跟随系统。

当前收录 29 组配色，每组都有氛围与简约版本（58 个家族、116 套浅深色皮肤）：

**角色氛围家族**（IP 主题，带壁纸水印、角色化设置入口、头部漫画装饰、文件夹开合图标等氛围玩法）：

- **名侦探柯南·月下追踪（conan）** —— 侦探蓝 / 蝴蝶结红 / 银白与午夜藏蓝；柯南角色壁纸、角色设置入口和晨光 / 雨夜米花街景长卷，配套简约版
- **灰原哀·琥珀微光（conan-haibara）** —— 鼠尾草绿 / 茶棕 / 琥珀与深夜青；日间捧杯与夜间研究立绘，雨后窗景 / 灯下研究室长卷，研究手册开合图标、咖啡与试剂道具，以及咖啡、研究、小猫三种灰原小伙伴
- **怪盗基德·月白预告（conan-kid）** —— 象牙白 / 宝石蓝 / 月光银；日间纸牌与夜间白鸽立绘，钟楼 / 月下屋顶长卷，预告函档案夹、礼帽与宝石道具，以及礼帽、白鸽、纸牌三种基德小伙伴
- **柯南·米花协奏（conan-ensemble）** —— 侦探蓝 / 领结红 / 月光银；柯南、小兰、新一、小哀、小五郎、平次与基德的日夜七人海报式群像，米花街景 / 月下屋顶长卷，案件卷宗开合图标与七位角色轮换入口
- **七龙珠·龟仙流夏日（dragon-ball-kame）** —— 海沫青 / 道服橙 / 珊瑚粉；童年悟空、克林、龟仙人与海龟的送奶修行和晚饭小憩，日夜龟仙屋海岛长卷、修行手册、牛奶箱与饭碗道具
- **七龙珠·金焰并肩（dragon-ball-z）** —— 护甲蓝 / 超赛金 / 深靛紫；悟空、贝吉塔、少年悟饭、比克与未来特兰克斯集结，日间常态与夜间超赛画面，荒原训练场长卷、护甲式任务夹与仙豆装备
- **七龙珠·神龙奇旅（dragon-ball-quest）** —— 神龙翡翠 / 四星琥珀 / 地图纸色；童年悟空、布尔玛、雅木茶、乌龙、普尔与神龙的寻珠冒险，山野胶囊小屋长卷、旅行地图夹与龙珠雷达道具

- **高达（gundam）** —— RX-78-2 装甲配色：装甲白 / 高达蓝 / 高达红 / V 字天线黄
- **电锯人·特异课（chainsaw）** —— 衬衫白 / 冷灰蓝 / 制服黑 / 暗红；电次、帕瓦、早川秋与波奇塔的早餐日常和夜间出勤群像
- **电锯人·玛奇玛（makima）** —— 象牙白 / 绯红 / 墨黑 / 眼瞳金；神社结印与夜间发动能力的场景壁纸，配套神社、办公室物件与角色语录
...
- **海贼王（one-piece）** —— 海洋蓝 / 海贼红 / 阳光金 / 暖羊皮纸，路飞、索隆、山治三人组与航海长卷
- **火影忍者·第七班（naruto）** —— 查克拉橙 / 木叶蓝 / 暖纸色；鸣人、佐助、小樱与卡卡西的第七班群像，配套木叶护额、苦无与修行卷轴
- **火影忍者·凯班（team-guy）** —— 连体衣绿 / 旗袍粉 / 绑腿橙；小李、宁次、天天的修行群像，配套天天的武器卷轴与灯笼、月圆火影岩长卷
- **鬼灭之刃·羁绊同行（kimetsu-bonds）** —— 青瓷绿 / 藤紫 / 月夜青；炭治郎、祢豆子、善逸、伊之助的旅途小憩与月下并肩，配套藤花山路与木箱行囊
- **鬼灭之刃·柱之誓约（kimetsu-hashira）** —— 象牙白 / 绯红 / 深靛蓝；炼狱杏寿郎、富冈义勇、胡蝶忍、时透无一郎的庭院集结与守夜群像，配套庭院头图与刀具收纳匣
- **鬼灭之刃·樱庭恋歌（kimetsu-sakura）** —— 樱粉 / 叶绿 / 夜梅紫；以甘露寺蜜璃为中心，搭配伊黑小芭内、胡蝶忍、栗花落香奈乎，浅色樱庭茶叙与深色花间守夜，配套樱饼食盒与茶具
...
所有氛围家族均有简约配对：复用基础浅深色板，不加载氛围表面覆盖或图片装饰。以下 7 个历史家族保留原名称和 ID；其余 22 个使用 `<氛围家族 ID>-minimal`，在设置页显示为「原主题名 · 简约」，分类跟随原主题。新增氛围家族时也需要添加一个简约配对。

- **青灰（slate）** —— 装甲白纸面 / 青灰墨色 / 钢蓝点缀（与高达族共享色板，但克制到认不出 IP）
- **冷墨（umber）** —— 冷白纸面 / 灰蓝 / 暗红（与电锯人·特异课共享新色板，保留原 umber ID 与偏好）
- **绯影（garnet）** —— 象牙白 / 绯红 / 哑光金（与电锯人·玛奇玛共享色板）
...
角色壁纸按原图比例显示。家族可用 `decor.wallpaperSize` 设置包含视口高度上限的 CSS 尺寸，首页、壁纸与输入区重绘同步使用；未指定的家族沿用既有尺寸。小窗口沿用柔和显示规则。
...
1. **选模式**：浅色／深色／跟随系统，以及清晰／柔和均使用分段选项。四个装饰部位的设置默认收起，点击「精细控制」展开头部横幅、右下角角色、左下角物件、设置角色与语录开关及恢复默认按钮。折叠只隐藏控件，不关闭装饰；展开状态不跨次保存。明暗、清晰度和装饰偏好仍按家族保存。
2. **选主题**：搜索中英文名称，使用全部／动漫／游戏／其他分类筛选。「显示简约」默认开启，可关闭并记住选择，仅隐藏简约卡片，不更改当前主题。选中即预览，并恢复该主题记住的配置。卡片左右展示浅深色板，氛围版用角色小图辅助辨认；简约版与原主题相邻，分类和搜索保留配对。分类维护于 `families/categories.json`。
3. **滚动主题库**：滚动仅限卡片区域，上方设置、搜索分类与底部应用按钮保持可见。没有场景预览。
4. **应用主题**：点击「应用」将预览中的主题设为当前主题。「返回当前主题」、切换设置页或关闭设置面板会结束预览，回到当前主题；已经自动保存的配置仍保留。「恢复默认」立即重置并保存该主题的清晰度与装饰选项，保留明暗模式。

选择「默认」并应用会交还内建外观，保留其他家族的个性化设置。清晰模式沿用原有宽屏规则；横幅在 ≤900px 隐藏，左下角物件在 ≤1050px 隐藏。

偏好按浏览器保存在 `localStorage["dsh-themes:pref"]`，使用版本 3 的 `{ version, selected, families, library: { showMinimal } }` 结构。旧 `{family, mode, style, wallpaper}` 和版本 2 自动迁移，保留原选中家族的明暗模式与各家族装饰配置，其他家族未记录的明暗模式默认跟随系统；不提供跨设备同步。 `library.showMinimal` 是全局筛选偏好，旧记录缺少此字段时默认为 `true`。
