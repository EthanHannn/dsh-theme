...
当前收录 26 组配色，每组都有氛围与简约版本（52 个家族、104 套浅深色皮肤）：
...
所有氛围家族均有简约配对：复用基础浅深色板，不加载氛围表面覆盖或图片装饰。以下 7 个历史家族保留原名称和 ID；其余 19 个使用 `<氛围家族 ID>-minimal`，在设置页显示为「原主题名 · 简约」，分类跟随原主题。新增氛围家族时也需要添加一个简约配对。
